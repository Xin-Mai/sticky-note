...
const ClockSwitch = styled(Switch)(({ theme }) => ({
  width: 62,
  height: 34,
  padding: 7,
  ...
  '& .MuiSwitch-thumb': {
    backgroundColor: (theme as Theme).palette.mode === 'dark' ? '#003892' : '#001e3c',
    width: 32,
    height: 32,
    '&:before': {
      content: "''",
  ...
  '& .MuiSwitch-track': {
    opacity: 1,
    backgroundColor: (theme as Theme).palette.mode === 'dark' ? '#8796A5' : '#aab4be',
    borderRadius: 20 / 2,
  },
}));
